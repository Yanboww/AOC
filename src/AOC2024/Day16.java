...
public class Day16 {
    ...
    public static int lowestScore (String fileName, int part)
    {
        ...
        int length = 141;
        if(fileName.contains("trial")) length = 17;
        ...
        while (!nodes.isEmpty() && !queue.isEmpty()){
            ...
            if(direction.equals("l") && cord[1]>0)
            {
                if(!map[cord[0]][cord[1]-1].equals("#")){
                    if(nodes.contains(cord[0]+","+(cord[1]-1)))queue.add(new int[]{cord[0],cord[1]-1});
            ...
            else if(direction.equals("d") && cord[0] < map.length-1)
            {
                ...
                {
                    if(nodes.contains(cord[0]+1+","+(cord[1])))queue.add(new int[]{cord[0]+1,cord[1]});
